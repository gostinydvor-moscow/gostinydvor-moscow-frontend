...
const MagazinePostPageNext = ({_id, title}) => {
    return (
        <Link to={`/magazine/${_id}`} className="magazine-post-page-next">
            <div className="magazine-post-page-next-text">
                <span className="subtitle magazine-post-page-next-text__subtitle">
                    К следующему посту
                </span>
                <h3 className="magazine-post-page-next-text__title">{title}</h3>
            </div>
...
export default MagazinePostPageNext;
