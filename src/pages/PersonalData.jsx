...
const PersonalData = () => {
    ...
    return (
        <>
            <Helmet>
                <title>
                    Политика обработки персональных данных - Гостиный двор
                    Москва
                </title>
            </Helmet>
                        ...
                        <div className="personal-data-text">
                            <div className="personal-data-text-block">
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    https://xn--b1abdpfxffsdl4i.xn--80adxhks/.
                                </p>
                            </div>
                            <div className="personal-data-text-block">
                                <h3 className="personal-data-text__title">
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    данных с помощью средств вычислительной
                                    техники.
                                </p>
                                <p className="personal-data-text__description">
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    их обработку информационных технологий и
                                    технических средств.
                                </p>
                                <p className="personal-data-text__description">
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    совместно с другими лицами организующие и
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    лиц (передача персональных данных) или на
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    данных и (или) уничтожаются материальные
                            ...
                            <div className="personal-data-text-block">
                                ...
                                <ul className="personal-data-text__ul">
                                    <li className="personal-data-text__li">
                            ...
                            <div className="personal-data-text-block">
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    недостоверные сведения о себе, либо сведения
                                    о другом субъекте персональных данных без
                                    согласия последнего, несут ответственность в
                            ...
                            <div className="personal-data-text-block">
                                ...
                                <p className="personal-data-text__description">
                                    5.3. данные о проекте.
                                </p>
                                <p className="personal-data-text__description">
                                    5.4. Также на сайте происходит сбор и
                                    обработка обезличенных данных о посетителях
                                    (в т.ч. файлов «cookie») с помощью сервисов
                                    интернет-статистики (Яндекс Метрика и Гугл
                                    Аналитика и других).
                                </p>
                                <p className="personal-data-text__description">
                                    5.5. Вышеперечисленные данные далее по
                                    тексту Политики объединены общим понятием
                                    Персональные данные.
                                </p>
                                <p className="personal-data-text__description">
                                    ...
                                    убеждений, интимной жизни, Оператором не
                                    осуществляется.
                                </p>
                                <p className="personal-data-text__description">
                                    5.7. Обработка персональных данных,
                                    разрешенных для распространения, из числа
                                    специальных категорий персональных данных,
                                    указанных в ч. 1 ст. 10 Закона о
                                ...
                                <p className="personal-data-text__description">
                                    5.8.2 Оператор обязан в срок не позднее трех
                                    рабочих дней с момента получения указанного
                                    согласия Пользователя опубликовать
                                    информацию об условиях обработки, о наличии
                                    запретов и условий на обработку
                                    неограниченным кругом лиц персональных
                                    данных, разрешенных для распространения.
                                </p>
                                <p className="personal-data-text__description">
                                    5.8.3 Передача (распространение,
                                    ...
                                    персональных данных. Данное требование
                                    должно включать в себя фамилию, имя,
                                    отчество (при наличии), контактную
                                    информацию (номер телефона, адрес
                                    электронной почты или почтовый адрес)
                                    субъекта персональных данных, а также
                                    перечень персональных данных, обработка
                                    которых подлежит прекращению. Указанные в
                                    данном требовании персональные данные могут
                                    обрабатываться только Оператором, которому
                                    оно направлено.
                                </p>
                                <p className="personal-data-text__description">
                                    5.8.4 Согласие на обработку персональных
                                    данных, разрешенных для распространения,
                                    прекращает свое действие с момента
                                    поступления Оператору требования, указанного
                                    в п. 5.8.3 настоящей Политики в отношении
                            ...
                            <div className="personal-data-text-block">
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    несовместимая с целями сбора персональных
                                    данных.
                                </p>
                                <p className="personal-data-text__description">
                            ...
                            <div className="personal-data-text-block">
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    услугах, специальных предложениях и
                                    различных событиях. Пользователь всегда
                                    может отказаться от получения информационных
                                    сообщений, направив Оператору письмо на
                                    адрес электронной почты
                                    gostinydvor.moscow@gmail.com с пометкой «Отказ от
                                    уведомлений о новых продуктах и услугах и
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    информации о действиях Пользователей на
                            ...
                            <div className="personal-data-text-block">
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    электронной почты. Заполняя соответствующие
                                    формы и/или отправляя свои персональные
                                    данные Оператору, Пользователь выражает свое
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    (включено сохранение файлов «cookie» и
                            ...
                            <div className="personal-data-text-block">
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    необходима для исполнения договора, стороной
                                    которого либо выгодоприобретателем или
                                    поручителем по которому является субъект
                                    персональных данных, а также для заключения
                                    договора по инициативе субъекта персональных
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    необходима для осуществления прав и законных
                                    интересов оператора или третьих лиц либо для
                                    достижения общественно значимых целей при
                            ...
                            <div className="personal-data-text-block">
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    обрабатываются Оператором, обеспечивается
                                    путем реализации правовых, организационных и
                                    технических мер, необходимых для выполнения
                                    в полном объеме требований действующего
                                ...
                                <p className="personal-data-text__description">
                                    10.2. Персональные данные Пользователя
                                    ...
                                    если субъектом персональных данных дано
                                    согласие Оператору на передачу данных
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    gostinydvor.moscow@gmail.com с пометкой
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    срок не предусмотрен договором или
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    адрес Оператора gostinydvor.moscow@gmail.com с
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    предоставления доступа), а также на
                                    обработку или условия обработки (кроме
                                    получения доступа) персональных данных,
                                    разрешенных для распространения, не
                                    действуют в случаях обработки персональных
                                    данных в государственных, общественных и
                                    иных публичных интересах, определенных
                                    законодательством РФ.
                                </p>
                                <p className="personal-data-text__description">
                                    10.7. Оператор при обработке персональных
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    данных, истечение срока действия согласия
                                    субъекта персональных данных или отзыв
                                    согласия субъектом персональных данных, а
                                    также выявление неправомерной обработки
                                    персональных данных.
                                </p>
                            </div>
                            <div className="personal-data-text-block">
                            ...
                            <div className="personal-data-text-block">
                                ...
                                <p className="personal-data-text__description">
                                    12.2. Трансграничная передача персональных
                                    данных на территории иностранных государств,
                                    не отвечающих вышеуказанным требованиям,
                                    может осуществляться только в случае наличия
                            ...
                            <div className="personal-data-text-block">
                                ...
                                <p className="personal-data-text__description">
                                    ...
                                    электронной почты gostinydvor.moscow@gmail.com.
                                </p>
                                <p className="personal-data-text__description">
                                    14.2. В данном документе будут отражены
                                    любые изменения политики обработки
                                    персональных данных Оператором. Политика
                                    действует бессрочно до замены ее новой
                                    версией.
                                </p>
                                <p className="personal-data-text__description">
                                    14.3. Актуальная версия Политики в свободном
                                    доступе расположена в сети Интернет по
                                    адресу
                                    https://xn--b1abdpfxffsdl4i.xn--80adxhks//personal-data.
                                </p>
                            </div>
                        </div>
                    </div>
